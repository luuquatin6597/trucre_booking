    ...
    <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            @foreach ($users as $role => $roleUsers)
                <li class="nav-item">
                    <a class="nav-link {{ $loop->first ? 'active' : '' }}" id="tab-{{ $role }}" data-toggle="tab" href="#{{ $role }}" role="tab" aria-controls="{{ $role }}" aria-selected="{{ $loop->first ? 'true' : 'false' }}">{{ ucfirst($role) }} Users</a>
                </li>
            @endforeach
        </ul>
        <div class="tab-content" id="myTabContent">
            @foreach ($users as $role => $roleUsers)
                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{ $role }}" role="tabpanel" aria-labelledby="tab-{{ $role }}">
                    <div class="row">
